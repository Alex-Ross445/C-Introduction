...
{
	int nhom;			// Nh�m/ch??ng m� c�u h?i n�y thu?c v?
	char noidung[255];	// N?i dung c�u h?i
	char dapan[5][255]; // C�c ?�p �n kh�c c?a c�u h?i.
} cauhoi;

int DS_Nhom[100];
int Dem_Nhom = 0;
void KiemTraNhom(int id)
{ // Ham kiem tra nhom da co chua, neu chua co thi tang bo dem len 1 va luu vao danh sach
	int i;
